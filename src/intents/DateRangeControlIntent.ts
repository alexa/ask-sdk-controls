...
export function hasOneOrMoreValues(input: DateRangeControlIntentSlots | null): boolean {
    ...
    if (
        input['AMAZON.DATE.a'] !== undefined ||
        input['AMAZON.DATE.b'] !== undefined ||
        input['AMAZON.DATE'] !== undefined
    ) {
        return true;
    }
    return false;
...
export function validateDateRangeControlIntentSlots(input: DateRangeControlIntentSlots | null): boolean {
    ...
    if (
        (input['AMAZON.DATE.a'] !== undefined && input['AMAZON.DATE.b'] === undefined) ||
        (input['AMAZON.DATE.b'] !== undefined && input['AMAZON.DATE.a'] === undefined)
    ) {
        return false;
    }
