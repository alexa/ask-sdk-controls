...
export class NumberControlAPLProps {
    ...
    // TODO js docs
    requestValue?: ControlAPL<RequestValueAct, NumberControlState>;
    requestChangedValue?: ControlAPL<RequestChangedValueAct, NumberControlState>;
    validationFailedMessage?: string | ((act: InvalidValueAct<number>) => string);
}
...
export class NumberControl extends Control implements InteractionModelContributor {
    ...
    private handleScreenEvent(input: ControlInput, resultBuilder: ControlResultBuilder): void {
        ...
        if (validationResult !== true) {
            this.fixInvalidValue(input, resultBuilder);
        } else {
    ...
    public getAplValidationFailedMessage() {
